...
namespace Rendering
{
  ...
  //      BasicEffectVertex(XMFLOAT4(0.8f, 0.0f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
		//BasicEffectVertex(XMFLOAT4(0.2f, 0.0f, 0.01f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
		//BasicEffectVertex(XMFLOAT4(1.1f, 0.9f, 0.01f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
		//BasicEffectVertex(XMFLOAT4(0.8f, 0.0f, 0.01f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
		//BasicEffectVertex(XMFLOAT4(-0.1f, 0.0f, 0.01f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
		//BasicEffectVertex(XMFLOAT4(-0.8f, 0.8f, 0.01f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
		//BasicEffectVertex(XMFLOAT4(-0.8f, 0.0f, 0.01f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
		//BasicEffectVertex(XMFLOAT4(-0.8f, 0.8f, 0.0f, 1.0f), XMFLOAT4(1.0f, 0.0f,0.0f,1.0f)),//red
		//BasicEffectVertex(XMFLOAT4(-1.0f, 0.6f, 0.0f, 1.0f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),//green
		//BasicEffectVertex(XMFLOAT4(-0.8f, 0.7f, 0.0f, 1.0f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),//blue
		//};
		...
		BasicEffectVertex vertices[] = {
		BasicEffectVertex(XMFLOAT4(-1.25f, 0.20f, 1.0f, 1.0f), XMFLOAT4(0.0f, 1.0f,0.0f,1.0f)),//V0
		BasicEffectVertex(XMFLOAT4(1.25f, 0.20f, 1.0f, 1.0f), XMFLOAT4(0.0f, 1.0f,0.0f,1.0f)),//V1 
		BasicEffectVertex(XMFLOAT4(1.25f, 0.20f, -1.5f, 1.0f), XMFLOAT4(0.0f, 1.0f,0.0f,1.0f)),//V2 
		BasicEffectVertex(XMFLOAT4(-1.25f, 0.20f, -1.5f, 1.0f), XMFLOAT4(0.0f, 1.0f,0.0f,1.0f)),//V3
		};
