...
namespace Rendering
{
	...
	private:
		...
		typedef struct _TextureMappingVertex { // Textures Vertex Format
			XMFLOAT4 Position;
		...
		ID3D11ShaderResourceView* mTextureShaderResourceView; // Declare member variables for texture mapping
